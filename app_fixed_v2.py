...
{sc("Campaigns",f"{ld['campaign_name'].nunique()}","Active",B,"n")}
        ...
        with o4:
            ...
            fig9a.update_layout(height=150, showlegend=False, **{**BASE, 'margin': dict(l=0, r=0, t=4, b=4)})
            ...
            fig9b.update_layout(height=115, bargap=0.45, xaxis=dict(showgrid=False, showticklabels=False, zeroline=False, range=[0, atc['Rate'].max()*1.4] if len(atc) else [0,10]), yaxis=dict(showgrid=False, tickfont=dict(size=10, color=TXT2)), **{**BASE, 'margin': dict(l=0, r=40, t=4, b=0)})
